...
public class RPGGameFlowModule : BaseGameFlowModule<RPGGameStateContext>
{
    ...
    protected override RPGGameStateContext CreateContext(IServiceContainer services)
    {
        return new RPGGameStateContext(
    ...
    protected override void RegisterStates(
        AsyncStateMachine<EGameState, RPGGameStateContext> sm)
    {
        ...
        AsyncStateMachine<EGameState, RPGGameStateContext> sm)
    {
        sm.RegisterState(EGameState.Loading,
            new LoadingState<RPGGameStateContext>(new ILoadingOperation<RPGGameStateContext>[]
            {
                new MainMenuLoading(),
                new GamePlayLoading()
            }));
    ...
    protected override void RegisterTransitions(
        AsyncStateMachine<EGameState, RPGGameStateContext> sm)
    {
        sm.AddTransition(new LoadingTransition<RPGGameStateContext>());
    }
