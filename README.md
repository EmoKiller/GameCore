...
- Trước khi khởi tạo hệ thống truy xuất InitializationOrder và GetDependencies() để phân nhóm thứ tự nạp. Nếu phụ thuộc chưa được nạp, hệ thống sẽ ưu tiên nạp chúng trước.
